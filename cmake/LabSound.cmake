...
file(GLOB dart_api "${LABSOUND_BRIDGING_ROOT}/dart_api/*")
set(labsnd_bridging "${LABSOUND_BRIDGING_ROOT}/LabSoundHelper.cpp")
...
elseif (ANDROID)
    set(LABSOUND_PLATFORM_LINK_LIBRARIES android)
else()
...
install(FILES "${LABSOUND_BRIDGING_ROOT}/LabSoundHelper.hpp"
    DESTINATION include/LabSound/bridging)
...
source_group(src\\bridging FILES ${labsnd_bridging})
